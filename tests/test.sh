...
grep -Fq 'vim.api.nvim_create_user_command("GoDebugFile"' "$ROOT/config/lua/config/keymaps.lua"
grep -Fq 'vim.api.nvim_create_user_command("GoDebugPackage"' "$ROOT/config/lua/config/keymaps.lua"
